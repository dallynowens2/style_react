        ...
        <div className='row'>
            ...
            <div className='col-10'>
                ...
                <div className='text-light lead p-2'>
                    I am a software engineer who recently graduated from Snow College. I have experience in using many different languages such
                    ...
                    team that is putting out great software and to continually get better at writing code that is clean, easy to understand, and testable.
                </div>
            </div>
