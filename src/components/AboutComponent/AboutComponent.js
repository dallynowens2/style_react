        ...
        <div className='row'>
            ...
            <div className='col-10'>
                ...
                <div className='text-light lead p-2'>
                    ...
                    as C#, JavaScript, Kotlin, Python, Java, SQL and many others. I have worked in different enviormetns such as using visual stuidio, VS code and android studio.
                    I have used different cloud servieces and containers such as Azure and Docker. Some of my goals are to always be learning and imporving my abilities, to be part of a great 
